...
//Quelle:
//https://github.com/danasf/hm10-android-arduino/blob/master/Android/BT4LEDTest/src/com/polkapolka/bluetooth/le/BluetoothLeService.java
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        if (UUID_HM_RX_TX.equals(characteristic.getUuid())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                    UUID.fromString(BluetoothConnectionManager.CLIENT_CHARACTERISTIC_CONFIG));
