...
public class FoodNoteActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foodnote);
        GoBack = (Button)findViewById(R.id.buttonback);
        GoBack.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FoodNoteActivity.this, SmartWatchActivity.class);
